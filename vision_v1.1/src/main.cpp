...
#include "io/interface/cboard.hpp"
...
int main(int argc, char * argv[])
{
  ...
  while (!exiter.exit()) {
    ...
    if (mode == io::Mode::auto_aim || mode == io::Mode::outpost) {
      ...
      auto command = aimer.aim(targets, t, hseven.bullet_speed);
    ...
    /// 打符
      ...
      if (mode == io::Mode::small_buff) {
        ...
        buff_command = buff_aimer.aim(target_copy, t, hseven.bullet_speed, true);
      } else if (mode == io::Mode::big_buff) {
        buff_big_target.get_target(power_runes, t);
        auto target_copy = buff_big_target;
        buff_command = buff_aimer.aim(target_copy, t, hseven.bullet_speed, true);
      }
      hseven.send(buff_command);
    }
